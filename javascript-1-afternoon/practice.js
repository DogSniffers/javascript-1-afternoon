...
function nameCheck(name){
  ...
  if(name==`Bryan`){return `Hey Bryan!`}
  if(name==`Joe`){return `Cool name, Joe`}
...
function faveColorFinder(name){
  if(name=='red'){return 'red is a great color'}
  if(name=='green'){return 'green is a solid favorite color'}
  if(name=='black'){return 'so trendy'}
